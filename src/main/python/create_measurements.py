...
def build_weather_station_name_list():
    ...
    """
    station_names = []
    with open('C:\\Users\\lovekushs\\Desktop\\1brc\\data\\weather_stations.csv', 'r',encoding='utf8') as file:
...
def build_test_data(weather_station_names, num_rows_to_create):
    ...
    try:
        with open("C:\\Users\\lovekushs\\Desktop\\1brc\\data\\measurements.txt", 'w',encoding="utf8") as file:
            progress = 0
    ...
    file_size = os.path.getsize("C:\\Users\\lovekushs\\Desktop\\1brc\\data\\measurements.txt")
